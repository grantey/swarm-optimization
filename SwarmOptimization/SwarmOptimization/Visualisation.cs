...
namespace SwarmOptimization
{
    ...
    {
        public Visualisation(SO swarm, int n, int d, int i)
        {
            InitializeComponent();
        ...
        private void DrawCoordinateSystem3D()
        {
            ...
            int dist;
            if (_fTransZ < -20) dist = 20 - (int)_fTransZ;
            else dist = 5;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < I; i++)
                for (int j = 0; j < D; j++) Swarm.SetX(r.NextDouble() * 5 + 5, /*r.NextDouble() * 2 - 1*/0, i, j);  
        ...
        {
            timer1.Interval = 1005 - (int)10*trackBar1.Value;
        }
