    ...
    public partial class Form1 : Form
    {
        ...
        private SO Init()
        {
            ...
            try
            {
                ...
                {
                    args = new double[] { Convert.ToDouble(textBox10.Text), Convert.ToDouble(textBox9.Text), Convert.ToDouble(textBox11.Text), Convert.ToDouble(textBox12.Text), Convert.ToDouble(textBox13.Text) };
        ...
        private void toolStripButton5_Click(object sender, EventArgs e)
        {
            ...
            {
                if (radioButton4.Checked) textBox1.Text += "Canonical PSO >> I = " + I + "  D = " + D + "  N = " + N + "  c1 = " + textBox3.Text + "  c2 = " + textBox4.Text;
                if (radioButton5.Checked) textBox1.Text += "Fully Informed PSO >> I = " + I + "  D = " + D + "  N = " + N + "  phi = " + textBox8.Text + "  K = " + textBox7.Text;
                if (radioButton6.Checked) textBox1.Text += "DEM PSO >> I = " + I + "  D = " + D + "  N = " + N + "  w = " + textBox10.Text + "  sigma = " + textBox9.Text + "  r = " + textBox11.Text + "  (p, q) = (" + textBox12.Text + ", " + textBox13.Text + ")";
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            Form2 Visualization = new Form2(Swarm, N, D, I);
        ...
        private void radioButton4_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButton4.Checked)
            {
                textBox8.Visible = textBox7.Visible = textBox10.Visible = textBox9.Visible = textBox11.Visible = textBox12.Visible = textBox13.Visible = false;
                textBox3.Visible = textBox4.Visible = true;
                label7.Visible = label6.Visible = label9.Visible = label8.Visible = label10.Visible = label11.Visible = label12.Visible = false;
                label3.Visible = label4.Visible = true;
            }
            if (radioButton5.Checked)
            {
                textBox3.Visible = textBox4.Visible = textBox10.Visible = textBox9.Visible = textBox11.Visible = textBox12.Visible = textBox13.Visible = false;
                textBox8.Visible = textBox7.Visible = true;
                label3.Visible = label4.Visible = label9.Visible = label8.Visible = label10.Visible = label11.Visible = label12.Visible = false;
                label6.Visible = label7.Visible = true;
            }
            if (radioButton6.Checked)
            {
                textBox10.Visible = textBox9.Visible = textBox11.Visible = textBox12.Visible = textBox13.Visible = true;
                textBox3.Visible = textBox4.Visible = textBox8.Visible = textBox7.Visible = false;
                label9.Visible = label8.Visible = label10.Visible = label11.Visible = label12.Visible = true;
